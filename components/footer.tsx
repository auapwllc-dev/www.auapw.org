    ...
    <footer className="bg-card/95 backdrop-blur-xl border-t border-border/30 relative overflow-hidden w-full automotive-pattern">
      ...
      <div className="mx-auto w-full max-w-7xl px-3 sm:px-4 md:px-6 lg:px-8">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 sm:gap-10 lg:gap-14 py-10 sm:py-14 lg:py-20">
          ...
          {/* Shop by Make — all brands as small pill boxes */}
          <div className="embossed-col p-3 sm:p-5 sm:col-span-2 lg:col-span-2">
            <h3 className="text-xs sm:text-sm font-black tracking-[0.2em] uppercase text-foreground text-3d-section mb-3 sm:mb-5 pb-2 sm:pb-3 border-b-2 border-primary/50 inline-block">
              Shop by Make
            </h3>
