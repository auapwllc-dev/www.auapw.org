...
function BrandLogo({ brand }: { brand: string }) {
  ...
  return (
    <div
      className="luxury-logo-tile w-full h-[28px] sm:h-[52px] flex items-center justify-center overflow-hidden rounded-md sm:rounded-lg"
...
function BrandCard({ brand }: { brand: string }) {
  return (
    <Link
      ...
      className="group relative flex flex-col items-center gap-0.5 sm:gap-1.5 p-1 sm:p-2.5 rounded-lg sm:rounded-xl cursor-pointer transition-all duration-300
...
export function BrandLogosSection() {
  ...
  // Return null during SSR to prevent hydration mismatch - content is interactive-only
